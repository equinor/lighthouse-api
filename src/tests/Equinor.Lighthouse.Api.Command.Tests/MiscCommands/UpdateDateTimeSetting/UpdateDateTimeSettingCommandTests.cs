...
using Equinor.Lighthouse.Api.Command.MiscCommands.UpdateDateTimeSetting;
using Equinor.Lighthouse.Api.Domain.AggregateModels.SettingAggregate;
using Equinor.Lighthouse.Api.Test.Common.ExtensionMethods;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using Moq;

namespace Equinor.Lighthouse.Api.Command.Tests.MiscCommands.UpdateDateTimeSetting
{
    [TestClass]
