...
using Equinor.Lighthouse.Api.MainApi.Tag;
...
using Moq;
using PCSProject = Equinor.Lighthouse.Api.MainApi.Permission.PCSProject;
...
namespace Equinor.Lighthouse.Api.WebApi.IntegrationTests
{
    public sealed class TestFactory : WebApplicationFactory<Startup>
    {
        ...
        private ApplicationContext DatabaseContext(IServiceCollection services)
        {
            ...
            return spScope.ServiceProvider.GetRequiredService<ApplicationContext>();
        }
